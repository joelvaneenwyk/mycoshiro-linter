...
export class GeneralTab extends Tab {
  ...
  display(): void {
    ...
    let setting = new Setting(tempDiv).setName(settingName).addToggle((toggle) => {
    ...
    new Setting(tempDiv)
      ...
      .setDesc(settingDesc)
      .addToggle((toggle) => {
        toggle.setValue(this.plugin.settings.displayChanged).onChange(async (value) => {
    ...
    new Setting(tempDiv)
      ...
      .setDesc(settingDesc)
      .addToggle((toggle) => {
        toggle.setValue(this.plugin.settings.lintOnFileChange).onChange(async (value) => {
    ...
    setting = new Setting(tempDiv).setName(settingName).addToggle((toggle) => {
      toggle.setValue(this.plugin.settings.displayLintOnFileChangeNotice).onChange(async (value) => {
    ...
    new Setting(tempDiv)
      ...
      .addDropdown((dropdown) => {
        dropdown.addOption(
          'system-default',
          getTextInLanguage('tabs.general.same-as-system-locale').replace('{SYS_LOCALE}', sysLocale)
        );
    ...
    new Setting(tempDiv)
      ...
      .addDropdown((dropdown) => {
        ...
        dropdown.onChange(async (value) => {
          this.plugin.settings.commonStyles.tagArrayStyle = value as
