...
export default {
  commands: {
    ...
    'lint-all-files-in-folder': {
      ...
      'start-message':
        'Bu, {FOLDER_NAME} dahilindeki tüm dosyalarınızı ve alt klasörlerini düzenler ve hatalara yol açabilir.',
  ...
  logs: {
    ...
    'paste-link-warning':
      'pano içeriği bir link olduğu ve yapıştırmayı değiştiren diğer eklentilerle çakışmayı önlemek için lintleme yapıştırması iptal edildi.',
    ...
    'moment-locale-not-found':
      'Moment.js yerelini {MOMENT_LOCALE} olarak değiştirmeye çalışıyor, elde edilen {CURRENT_LOCALE}',
    ...
    'custom-lint-duplicate-warning':
      'Aynı komutu ("{COMMAND_NAME}") özel bir lint kuralı olarak iki kez çalıştıramazsınız.',
    ...
    'timing-key-not-found':
      "'{TIMING_KEY}' zamanlama anahtarı zamanlama bilgisi listesinde bulunamadı, bu yüzden yoksayıldı",
    'milliseconds-abbreviation': 'ms',

    'invalid-date-format-error':
      "Oluşturulan tarih formatı '{DATE}' ayrıştırılamadı veya belirlenemedi, bu yüzden '{FILE_NAME}' dosyasındaki oluşturulan tarih aynı bırakıldı",
    ...
    'missing-footnote-error-message':
      "'{FOOTNOTE}' dipnotunun içeriğinden önce karşılık gelen bir dipnot referansı yok ve işlenemez. Lütfen tüm dipnotların, dipnot içeriğinden önce karşılık gelen bir referansı olduğundan emin olun.",
    'too-many-footnotes-error-message':
      "'{FOOTNOTE_KEY}' dipnot anahtarı birden fazla dipnota atıfta bulunuyor. Lütfen dipnotları güncelleyin, böylece her dipnot anahtarı için yalnızca bir dipnot olur.",
    ...
    'uneven-amount-of-quotes':
      'Dosyadaki `{QUOTE}` alıntısının sayısı çift değil, bu yüzden düz alıntıları akıllı alıntılara dönüştüremeyiz'
  },
  ...
  tabs: {
    ...
    general: {
      ...
      'lint-on-save': {
        ...
        description:
          'Manuel kaydetme (Ctrl + S tuşuna basıldığında veya vim tuş bağlamalarını kullanırken :w komutu çalıştırıldığında) dosyayı düzeltir'
      },
      'display-message': {
      ...
      'folders-to-ignore': {
        ...
        description:
          'Tüm dosyaları düzeltirken veya kaydederken düzeltme işleminin yoksayılacağı klasörler. Klasör yollarını yeni satırlarla ayırarak girin'
      },
      'override-locale': {
      ...
      'default-escape-character': {
        ...
        description:
          'Tek tırnak ve çift tırnak bulunmayan YAML değerlerinden kaçmak için kullanılacak varsayılan karakter.'
      },
      'remove-unnecessary-escape-chars-in-multi-line-arrays': {
        ...
        description:
          'Çok satırlı YAML dizileri için kaçış karakterleri tek satırlı dizilere göre aynı kaçışa ihtiyaç duymaz, bu yüzden çok satırlı format içerisinde gerekli olmayan ekstra kaçışları kaldırır'
      },
      'number-of-dollar-signs-to-indicate-math-block': {
        name: 'Matematiksel Bloğu Belirtmek İçin Dolar İşareti Sayısı',
        description:
          'Matematik içeriğinin bir matematiksel blok yerine inline matematik olup olmadığını belirlemek için kullanılacak dolar işareti sayısı'
      }
    },
    debug: {
      // debug-tab.ts
      ...
      'log-collection': {
        ...
        description:
          '`Kaydetme düzeltmesi` yaptığınızda ve mevcut dosyayı düzeltirken logları toplar. Bu loglar hata ayıklama ve hata raporları oluşturma için yardımcı olabilir.'
      },
      'linter-logs': {
        name: 'Linter Logları',
        description:
          'Son `Kaydetme düzeltmesi` veya son mevcut dosya çalıştırmasından elde edilen loglar (eğer etkinleştirilmişse).'
      }
    }
  },
  ...
  options: {
    'custom-command': {
      ...
      name: 'Özel Komutlar',
      description:
        'Özel komutlar, linter normal kurallarını çalıştırmayı bitirdikten sonra çalıştırılan Obsidyen komutlardır. Bu, YAML zaman damgası mantığı çalışmadan önce çalışmadıkları anlamına gelir, dolayısıyla linterin bir sonraki çalışmasında YAML zaman damgasının tetiklenmesine neden olabilirler. Bir Obsidyen komutunu yalnızca bir kez seçebilirsiniz. **_Bunun şu anda yalnızca geçerli dosyaya satır dizilirken çalıştığını unutmayın._**',
      warning:
        'Bir seçeneği seçerken, seçeneği fareyi kullanarak veya enter tuşuna basarak seçtiğinizden emin olun. Diğer seçim yöntemleri çalışmayabilir ve yalnızca gerçek bir Obsidian komutunun veya boş bir dizinin seçimleri kaydedilir.',
    ...
    'custom-replace': {
      ...
      description:
        'Özel regex değiştirme, bulunan regex ile eşleşen her şeyi değiştirme değeri ile değiştirmek için kullanılabilir. Değiştirme ve bulma değerleri geçerli regex değerleri olmalıdır.',
      warning:
        'Regex hakkında bilginiz yoksa dikkatli kullanın. Ayrıca, lütle iOS mobil platformunda regexinizde geriye dönük aramaları kullanmayın çünkü bu, o platformda desteklenmediği için lint işleminin başarısız olmasına neden olur.',
  ...
  rules: {
    ...
    'auto-correct-common-misspellings': {
      ...
      description:
        'Yaygın yanlış yazımların sözlüğünü kullanarak bunları doğru yazımlarına otomatik olarak dönüştürür. Otomatik düzeltilen kelimelerin tam listesi için [otomatik-düzeltme haritasına](https://github.com/platers/obsidian-linter/tree/master/src/utils/auto-correct-misspellings.ts) bakın.',
      'ignore-words': {
    ...
    'add-blockquote-indentation-on-paste': {
      ...
      description:
        'İmleç bir blok alıntı/callout satırında olduğunda, tüm satırlara, ilk satır hariç, blok alıntılar ekler'
    },
    // blockquote-style.ts
    'blockquote-style': {
    ...
    'empty-line-around-blockquotes': {
      ...
      description:
        'Bir belgenin başını veya sonunu başlatmayan alıntı blokların etrafında boş bir satır olmalıdır. **Not: boş bir satır ya alıntı bloklar için bir seviye daha az girinti veya yeni bir satır karakteri demektir.**'
    },
    ...
    'empty-line-around-math-blocks': {
      ...
      description:
        'Tek satırlık matematik için bir matematik bloğunu belirtmek için kaç dolar işareti olduğunu belirleyen `Dolar İşaretlerinin Sayısıyla Matematik Bloğunu Belirt` kullanılarak matematik bloklarının etrafında boş bir satır olmalıdır.'
    },
    ...
    'escape-yaml-special-characters': {
      ...
      description:
        'YAML içindeki boşlukla beraber gelen iki nokta üst üste (:), tek tırnak (\') ve çift tırnak (") karakterlerini kaçış işlemine tabi tutar.',
      'try-to-escape-single-line-arrays': {
        name: 'Tek Satırlık Listeleri Kaçış Denemesi',
        description:
          'Bir dizinin "[" ile başladığını, "]" ile bittiğini ve öğelerin "," ile ayrıldığını varsayarak dizi değerlerini kaçış işlemine tabi tutmaya çalışır.'
      }
    },
    ...
    'force-yaml-escape': {
      ...
      'force-yaml-escape-keys': {
        ...
        description:
          'Yeni bir satır karakteri ile ayrılmış belirtilen YAML anahtarlarında YAML kaçış karakterini kullanır, eğer zaten kaçış yapılmamışsa. YAML dizilerinde kullanmayın'
      }
    },
    ...
    'format-yaml-array': {
      ...
      description:
        'Normal YAML dizilerinin çok satırlı veya tek satırlı olarak biçimlendirilmesine izin verir ve `tags` ve `aliases` bazı Obsidian özgü özelliklerine sahip YAML formatlarında bulunabilir. **Not: Tek girişli bir diziden birden fazla girişi olan tek satırlı bir diziye geçmek aynıdır, tek fark çok satırlı bir dizi olmasıdır.**',
      'alias-key': {
        name: 'YAML takma adları bölümünü biçimlendir',
        description:
          'YAML takma adları bölümü için biçimlendirmeyi açar. Bu seçeneği `YAML Title Alias` kuralıyla birlikte kullanmamanız önerilir çünkü birlikte düzgün çalışmayabilir veya farklı biçimlendirme stilleri seçilmiş olabilir, bu beklenmeyen sonuçlara yol açabilir.'
      },
      'tag-key': {
      ...
      'default-array-style': {
        ...
        description:
          '`tags`, `aliases` veya `Force key values to be single-line arrays` ve `Force key values to be multi-line arrays` olmayan diğer YAML dizilerinin stili'
      },
      'default-array-keys': {
      ...
      'force-single-line-array-style': {
        ...
        description:
          'Yeni satır ile ayrılan anahtarlar için YAML dizisini tek satırlı formatta olmaya zorlar (bu seçeneği devre dışı bırakmak için boş bırakın)'
      },
      'force-multi-line-array-style': {
        name: 'Anahtar değerlerini çok satırlı dizilere zorla',
        description:
          'Yeni satır ile ayrılan anahtarlar için YAML dizisini çok satırlı formatta olmaya zorlar (bu seçeneği devre dışı bırakmak için boş bırakın)'
      }
    },
    // header-increment.ts
    'header-increment': {
      ...
      'start-at-h2': {
        ...
        description:
          'Bir dosyadaki minimum başlık seviyesini başlık seviyesi 2 yapar ve buna göre tüm başlıkları kaydırır, böylece başlık artışı seviye 2 başlığı ile başlar.'
      }
    },
    ...
    'heading-blank-lines': {
      ...
      description:
        'Tüm başlıkların hem öncesinde hem de sonrasında birer boş satır olmalıdır (başlık belgenin başında veya sonunda olduğunda bu durum geçerli değildir).',
      bottom: {
        name: 'Alt',
    ...
    'headings-start-line': {
      ...
      description:
        'Bir satırı başlatmayan başlıkların öncesi boşlukları kaldırılır ki başlıklar başlık olarak tanınabilsin.'
    },
    ...
    'move-math-block-indicators-to-their-own-line': {
      ...
      description:
        'Tek satırlı matematik için kaç dolar işaretinin bir matematik bloğunu gösterdiğini belirlemek için "Bir Matematik Bloğu Göstermek İçin Dolar İşareti Sayısı"nı kullanarak tüm başlangıç ve bitiş matematik bloğu göstergelerini kendi satırlarına taşıyın.'
    },
    ...
    'move-tags-to-yaml': {
      ...
      'how-to-handle-existing-tags': {
        ...
        description:
          'Ön maddeye taşındıktan sonra dosyanın içeriğinde bulunan ve yoksayılmayan etiketlerle ne yapılacağı'
      },
      'tags-to-ignore': {
        name: 'Yoksayılacak etiketler',
        description:
          "İçerik gövdesindeki hashtag'lerden kaldırma etkinleştirilmişse, etiketler dizisine taşınmayacak veya içerik gövdesinden kaldırılmayacak etiketler. Her etiket yeni bir satırda ve `#` olmadan olmalıdır. **Etiket adında hashtag içermediğinizden emin olun.**"
      }
    },
    // no-bare-urls.ts
    'no-bare-urls': {
      ...
      description:
        "Yalın URL'leri açılı ayraçlar ile kuşatır, tek veya çift tırnak, köşeli parantez veya eğik kesme işareti içinde değilse."
    },
    // ordered-list-style.ts
    'ordered-list-style': {
      name: 'Sıralı Liste Stili',
      description:
        'Sıralı listelerin belirtilen stili izlemesini sağlar. **Not: 2 boşluk veya 1 sekme bir girinti seviyesi olarak kabul edilir.**',
      'number-style': {
        name: 'Numara Stili',
    ...
    'prevent-double-checklist-indicator-on-paste': {
      ...
      description:
        'Kursörün dosyadaki satırda bir kontrol listesi göstergesi varsa, yapıştırılacak metinden başlangıç kontrol listesi göstergesini kaldırır'
    },
    // prevent-double-list-item-indicator-on-paste.ts
    'prevent-double-list-item-indicator-on-paste': {
      name: 'Yapıştırmada Çift Liste Öğesi Göstergesini Önle',
      description:
        'Kursörün dosyadaki satırda bir liste göstergesi varsa, yapıştırılacak metinden başlangıç listesi göstergesini kaldırır'
    },
    // proper-ellipsis-on-paste.ts
    'proper-ellipsis-on-paste': {
      name: 'Yapıştırmada Uygun Üç Nokta',
      description:
        'Yapıştırılacak metinde aralarında boşluk olsa bile ardışık üç noktayı, üç nokta karakteriyle ile değiştirir'
    },
    // proper-ellipsis.ts
    'proper-ellipsis': {
      name: 'Uygun Üç Nokta',
    ...
    're-index-footnotes': {
      ...
      description:
        'Dipnot anahtarlarını ve dipnotları, oluşum sırasına göre yeniden indeksler. **Not: Bir anahtar için birden fazla dipnot varsa, bu kural çalışmaz.**'
    },
    ...
    'remove-multiple-spaces': {
      ...
      description:
        'İki veya daha fazla ardışık boşluğu kaldırır. Satırın başındaki ve sonundaki boşlukları görmezden gelir. '
    },
    // remove-space-around-characters.ts
    'remove-space-around-characters': {
      name: 'Karakterler Etrafındaki Boşluğu Kaldır',
      description:
        'Belirli karakterlerin boşluklarla (tek boşluk veya sekme) çevrelenmemesini sağlar. **Not: Bu, bazı durumlarda indirim biçimiyle ilgili sorunlara neden olabilir.**',
    ...
    'remove-space-before-or-after-characters': {
      ...
      description:
        'Belirtilen karakterlerden önceki ve sonraki boşluğu kaldırır. **Not: bu durum bazı durumlarda markdown formatında sorunlara neden olabilir.**',
      'characters-to-remove-space-before': {
        name: 'Önceki Boşluğu Kaldırılacak Karakterler',
        description:
          'Belirtilen karakterlerden önceki boşluğu kaldırır. **Not: karakter listesinde `{` veya `}` kullanmak, sahne arkasında yoksayma sözdizimi kullanıldığı için dosyaları beklenmedik şekilde etkiler.**'
      },
      'characters-to-remove-space-after': {
        name: 'Sonraki Boşluğu Kaldırılacak Karakterler',
        description:
          'Belirtilen karakterlerden sonraki boşluğu kaldırır. **Not: karakter listesinde `{` veya `}` kullanmak, sahne arkasında yoksayma sözdizimi kullanıldığı için dosyaları beklenmedik şekilde etkiler.**'
      }
    },
    ...
    'remove-trailing-punctuation-in-heading': {
      ...
      description:
        'Belirtilen noktalama işaretlerini başlıkların sonundan kaldırır ve [HTML varlık referanslarının](https://en.wikipedia.org/wiki/List_of_XML_and_HTML_character_entity_references) sonundaki noktalı virgülü yoksayar.',
    ...
    'space-between-chinese-japanese-or-korean-and-english-or-numbers': {
      ...
      description:
        'Çince, Japonca veya Korece ve İngilizce veya sayılar arasında tek bir boşluk olması gerektiğini sağlar. Bu [kuralları](https://github.com/sparanoid/chinese-copywriting-guidelines) takip eder'
    },
    // strong-style.ts
    'strong-style': {
      name: 'Kalın Stil',
    ...
    'two-spaces-between-lines-with-content': {
      ...
      description:
        'İçeriği devam eden satırların sonuna paragraflar, blok alıntıları ve liste öğeleri için iki boşluk eklenmesini sağlar'
    },
    ...
    'yaml-key-sort': {
      ...
      description:
        'YAML anahtarlarını belirtilen sıra ve önceliğe göre sıralar. **Not: boş satırları da kaldırabilir.**',
    ...
    'yaml-timestamp': {
      ...
      description:
        'Dosyanın son düzenlendiği tarihi YAML ön maddesinde takip eder. Tarihler dosya metadatasından alınır.',
      'date-created': {
      ...
      'force-retention-of-create-value': {
        ...
        description:
          'Dosya metadatası yerine YAML ön maddesindeki tarihi yeniden kullanır, bu da dosya metadatasındaki değişikliklerin değerin farklı bir değere değişmesine neden olmasını önler.'
      },
      'date-modified': {
      ...
      format: {
        name: 'Format',
        description:
          'Kullanılacak Zaman formatı (bakınız [Moment format options](https://momentjscom.readthedocs.io/en/latest/moment/04-displaying/01-format/))'
      }
    },
    // yaml-title-alias.ts
    'yaml-title-alias': {
      ...
      description:
        'Dosyanın başlığını YAML ön maddesinin takma adları bölümüne ekler. Başlığı ilk H1 veya dosya adından alır.',
