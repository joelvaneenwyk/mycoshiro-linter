...
export default {
  commands: {
    ...
    'lint-all-files-in-folder': {
      ...
      'start-message':
        'Dadurch werden alle Ihre Dateien in {FOLDER_NAME} bearbeitet, einschließlich der Dateien in den Unterordnern, die zu Fehlern führen können.',
      ...
      'message-plural':
        'Alle {FILE_COUNT}-Dateien in {FOLDER_NAME} wurden gelinzelt und es gab einen {ERROR_COUNT}-Fehler.'
    },
    'paste-as-plain-text': {
  ...
  logs: {
    ...
    'paste-link-warning':
      'Abgebrochenes Einfügen von Flusen, da der Inhalt der Zwischenablage ein Link ist, wodurch Konflikte mit anderen Plugins vermieden werden, die das Einfügen ändern.',
    ...
    'custom-lint-duplicate-warning':
      'Sie können denselben Befehl ("{COMMAND_NAME}") nicht zweimal als benutzerdefinierte Lint-Regel ausführen.',
    ...
    'timing-key-not-found':
      "Der Timing-Schlüssel '{TIMING_KEY}' ist in der Timing-Info-Liste nicht vorhanden, daher wurde er ignoriert",
    ...
    'missing-footnote-error-message':
      "Die Fußnote '{FOOTNOTE}' hat keinen entsprechenden Fußnotenverweis vor dem Fußnoteninhalt und kann nicht verarbeitet werden. Bitte achten Sie darauf, dass alle Fußnoten vor dem Inhalt der Fußnote einen entsprechenden Verweis haben.",
    'too-many-footnotes-error-message':
      "Der Fußnotenschlüssel '{FOOTNOTE_KEY}' hat mehr als 1 Fußnote, die darauf verweist. Bitte aktualisieren Sie die Fußnoten so, dass es nur noch eine Fußnote pro Fußnotenschlüssel gibt.",
    ...
    'uneven-amount-of-quotes':
      'Die Vorkommen des Anführungszeichens `{QUOTE}` in der Datei sind nicht gerade, daher können wir gerade Anführungszeichen nicht in intelligente Anführungszeichen umwandeln'
  },
  ...
  tabs: {
    ...
    general: {
      ...
      'lint-on-save': {
        ...
        description:
          'Lenken Sie die Datei beim manuellen Speichern (wenn `Strg + S` gedrückt wird oder wenn `:w` ausgeführt wird, während vim-Tastenkombinationen verwendet werden)'
      },
      'display-message': {
      ...
      'lint-on-file-change': {
        ...
        description:
          'Wenn eine Datei geschlossen oder eine neue Datei ausgelagert wird, wird die vorherige Datei mit Flusen versehen.'
      },
      ...
      'folders-to-ignore': {
        ...
        description:
          'Ordner, die ignoriert werden sollen, wenn alle Dateien gestürzt oder beim Speichern gestürzt werden. Geben Sie Ordnerpfade ein, die durch Zeilenumbrüche getrennt sind'
      },
      'override-locale': {
        name: 'Gebietsschema überschreiben',
        description:
          'Legen Sie diese Option fest, wenn Sie ein anderes Gebietsschema als das Standardgebietsschema verwenden möchten'
      },
      ...
      'default-escape-character': {
        ...
        description:
          'Das Standardzeichen, das zum Maskieren von YAML-Werten verwendet werden soll, wenn ein einfaches Anführungszeichen und kein doppeltes Anführungszeichen vorhanden sind.'
      },
      'remove-unnecessary-escape-chars-in-multi-line-arrays': {
        ...
        description:
          'Escape-Zeichen für mehrzeilige YAML-Arrays benötigen nicht die gleiche Escape-Funktion wie einzeilige Arrays. Entfernen Sie also im mehrzeiligen Format zusätzliche Escapezeichen, die nicht erforderlich sind'
      },
    ...
    debug: {
      ...
      'log-level': {
        name: 'Log-Ebene',
        description:
          'Die Arten von Protokollen, die vom Dienst protokolliert werden dürfen. Der Standardwert ist Fehler.'
      },
      'linter-config': {
      ...
      'log-collection': {
        ...
        description:
          'Geht voran und sammelt Protokolle, wenn Sie `Flusen beim Speichern` und die aktuelle Datei flusen. Diese Protokolle können beim Debuggen und Erstellen von Fehlerberichten hilfreich sein.'
      },
      'linter-logs': {
        name: 'Linter-Protokolle',
        description:
          'Die Protokolle der letzten `Flusen beim Speichern` oder der letzten aktuellen Flusendatei werden ausgeführt, wenn sie aktiviert sind.'
      }
    }
  },
  ...
  options: {
    'custom-command': {
      ...
      description:
        'Benutzerdefinierte Befehle sind Obsidian-Befehle, die ausgeführt werden, nachdem der Linter seine regulären Regeln ausgeführt hat. Dies bedeutet, dass sie nicht ausgeführt werden, bevor die YAML-Zeitstempellogik ausgeführt wird, sodass sie dazu führen können, dass der YAML-Zeitstempel bei der nächsten Ausführung des Linter ausgelöst wird. Sie können einen Obsidian-Befehl nur einmal auswählen. **_Beachten Sie, dass dies derzeit nur beim Flusen der aktuellen Datei funktioniert._**',
      warning:
        'Wenn Sie eine Option auswählen, stellen Sie sicher, dass Sie die Option entweder mit der Maus oder durch Drücken der Eingabetaste auswählen. Andere Auswahlmethoden funktionieren möglicherweise nicht und es werden nur Auswahlen eines tatsächlichen Obsidian-Befehls oder einer leeren Zeichenfolge gespeichert.',
    ...
    'custom-replace': {
      ...
      description:
        'Der benutzerdefinierte Regex-Ersatz kann verwendet werden, um alles zu ersetzen, was mit dem Such-Regex mit dem Ersatzwert übereinstimmt. Bei den Werten replace und find muss es sich um gültige Regex-Werte handeln.',
      warning:
        'Verwenden Sie dies mit Vorsicht, wenn Sie Regex nicht kennen. Stellen Sie außerdem sicher, dass Sie keine Lookbehinds in Ihrem regulären Ausdruck auf iOS-Mobilgeräten verwenden, da dies dazu führt, dass Flusen fehlschlagen, da dies auf dieser Plattform nicht unterstützt wird.',
  ...
  rules: {
    ...
    'auto-correct-common-misspellings': {
      ...
      description:
        'Verwendet ein Wörterbuch mit häufigen Rechtschreibfehlern, um sie automatisch in die richtige Schreibweise umzuwandeln. Siehe [Autokorrekturkarte](https://github.com/platers/obsidian-linter/tree/master/src/utils/auto-correct-misspellings.ts) für die vollständige Liste der automatisch korrigierten Wörter.',
      'ignore-words': {
        name: 'Ignorieren Sie Wörter',
        description:
          'Eine durch Kommas getrennte Liste von Wörtern in Kleinbuchstaben, die bei der automatischen Korrektur ignoriert werden sollen'
      }
    },
    ...
    'add-blockquote-indentation-on-paste': {
      ...
      description:
        'Fügt Blockzitate zu allen außer der ersten Zeile hinzu, wenn sich der Cursor während des Einfügens in einer Blockquote/Callout-Zeile befindet'
    },
    // blockquote-style.ts
    'blockquote-style': {
    ...
    'empty-line-around-blockquotes': {
      ...
      description:
        'Stellt sicher, dass Blockzitate in einer leeren Zeile stehen, es sei denn, sie beginnen oder beenden ein Dokument. **Beachten Sie, dass eine leere Zeile entweder eine Verschachtelungsebene weniger für Blockzitate oder ein Zeilenumbruchzeichen ist.**'
    },
    // empty-line-around-code-fences.ts
    'empty-line-around-code-fences': {
      name: 'Leere Zeile um Code-Zäune',
      description:
        'Stellt sicher, dass Codezäune mit einer leeren Zeile versehen sind, es sei denn, sie beginnen oder beenden ein Dokument.'
    },
    // empty-line-around-math-block.ts
    'empty-line-around-math-blocks': {
      name: 'Leere Zeile um mathematische Blöcke',
      description:
        'Stellt sicher, dass es eine leere Zeile um mathematische Blöcke gibt, indem `Anzahl der Dollarzeichen, die einen mathematischen Block anzeigen` verwendet wird, um zu bestimmen, wie viele Dollarzeichen einen mathematischen Block für einzeilige Mathematik anzeigen.'
    },
    // empty-line-around-tables.ts
    'empty-line-around-tables': {
      name: 'Leere Zeile um Tabellen',
      description:
        'Stellt sicher, dass es eine leere Zeile um Github-Tabellen gibt, es sei denn, sie beginnen oder beenden ein Dokument.'
    },
    // escape-yaml-special-characters.ts
    'escape-yaml-special-characters': {
      name: 'Escape-YAML-Sonderzeichen',
      description:
        'Maskiert Doppelpunkte mit einem Leerzeichen nach ihnen (:), einfache Anführungszeichen (\') und doppelte Anführungszeichen (") in YAML.',
      'try-to-escape-single-line-arrays': {
        name: 'Versuchen Sie, Single-Line-Arrays zu umgehen',
        description:
          'Versucht, Arraywerte zu maskieren, wobei davon ausgegangen wird, dass ein Array mit "[" beginnt, mit "]" endet und Elemente enthält, die durch "," getrennt sind.'
      }
    },
    ...
    'force-yaml-escape': {
      ...
      'force-yaml-escape-keys': {
        ...
        description:
          'Verwendet das YAML-Escapezeichen für die angegebenen YAML-Schlüssel, die durch ein Zeilenumbruchzeichen getrennt sind, wenn es nicht bereits mit Escapezeichen versehen ist. Nicht auf YAML-Arrays verwenden.'
      }
    },
    ...
    'format-yaml-array': {
      ...
      'default-array-style': {
        ...
        description:
          'Der Stil anderer YAML-Arrays, die nicht `schilder`, `decknamen` oder in `Erzwingen von Schlüsselwerten, dass es sich um einzeilige Arrays handelt` und `Erzwingen von Schlüsselwerten, dass es sich um mehrzeilige Arrays handelt` sind'
      },
      'default-array-keys': {
      ...
      'force-single-line-array-style': {
        ...
        description:
          'Erzwingt, dass das YAML-Array für die neuen zeilengetrennten Schlüssel im einzeiligen Format vorliegt (leer lassen, um diese Option zu deaktivieren)'
      },
      'force-multi-line-array-style': {
        name: 'Erzwingen von Schlüsselwerten, dass es sich um mehrzeilige Arrays handelt',
        description:
          'Erzwingt, dass das YAML-Array für die neuen zeilengetrennten Schlüssel im mehrzeiligen Format vorliegt (leer lassen, um diese Option zu deaktivieren)'
      }
    },
    // header-increment.ts
    'header-increment': {
      ...
      'start-at-h2': {
        ...
        description:
          'Legt die Überschriftenebene 2 als minimale Überschriftenebene in einer Datei für das Kopfzeileninkrement fest und verschiebt alle Überschriften entsprechend, sodass sie beginnend mit einer Überschrift der Ebene 2 inkrementiert werden.'
      }
    },
    ...
    'heading-blank-lines': {
      ...
      description:
        'Alle Überschriften haben sowohl davor als auch danach eine Leerzeile (außer wenn sich die Überschrift am Anfang oder Ende des Dokuments befindet).',
      bottom: {
        name: 'Unteres',
    ...
    'headings-start-line': {
      ...
      description:
        'Bei Überschriften, die keine Zeile beginnen, wird der vorangehende Leerraum entfernt, um sicherzustellen, dass sie als Überschriften erkannt werden.'
    },
    // insert-yaml-attributes.ts
    'insert-yaml-attributes': {
      name: 'Einfügen von YAML-Attributen',
      description:
        'Fügt die angegebenen YAML-Attribute in die YAML-Frontmaterie ein. Setzen Sie jedes Attribut in eine einzelne Zeile.',
      'text-to-insert': {
    ...
    'move-math-block-indicators-to-their-own-line': {
      ...
      description:
        'Verschieben Sie alle Anfangs- und Endindikatoren für mathematische Blöcke in ihre eigenen Zeilen, indem Sie `Anzahl der Dollarzeichen, die einen mathematischen Block anzeigen` verwenden, um zu bestimmen, wie viele Dollarzeichen einen mathematischen Block für einzeilige Mathematik anzeigen.'
    },
    ...
    'move-tags-to-yaml': {
      ...
      'how-to-handle-existing-tags': {
        ...
        description:
          'Die Aktion, die mit nicht ignorierten Tags im Hauptteil der Datei ausgeführt werden soll, nachdem sie in die Frontmaterie verschoben wurden'
      },
      'tags-to-ignore': {
        name: 'Tags zum Ignorieren',
        description:
          'Die Tags, die nicht in das Tags-Array verschoben oder aus dem Textinhalt entfernt werden, wenn `Entfernen Sie den Hashtag aus Tags im Inhaltstext` aktiviert ist. Jedes Tag sollte in einer neuen Zeile und ohne das `#`` stehen. **Stellen Sie sicher, dass Sie den Hashtag nicht in den Tag-Namen aufnehmen.**'
      }
    },
    // no-bare-urls.ts
    'no-bare-urls': {
      ...
      description:
        'Umschließt bloße URLs mit spitzen Klammern, es sei denn, sie sind in hintere Häkchen, eckige Klammern oder einfache oder doppelte Anführungszeichen eingeschlossen.'
    },
    // ordered-list-style.ts
    'ordered-list-style': {
      name: 'Geordneter Listenstil',
      description:
        'Stellt sicher, dass geordnete Listen dem angegebenen Stil entsprechen. Beachten Sie, dass 2 Leerzeichen oder 1 Tabulator als Einrückungsebene betrachtet werden.',
      'number-style': {
        name: 'Zahlen-Stil',
    ...
    'prevent-double-checklist-indicator-on-paste': {
      ...
      description:
        'Entfernt die Start-Checklisten-Anzeige aus dem Text, um sie einzufügen, wenn die Zeile, auf der sich der Cursor in der Datei befindet, über eine Checklistenanzeige verfügt'
    },
    ...
    'prevent-double-list-item-indicator-on-paste': {
      ...
      description:
        'Entfernt den Startlistenindikator aus dem Text, der eingefügt werden soll, wenn die Zeile, auf der sich der Cursor in der Datei befindet, einen Listenindikator hat'
    },
    // proper-ellipsis-on-paste.ts
    'proper-ellipsis-on-paste': {
      name: 'Richtige Auslassungspunkte auf Paste',
      description:
        'Ersetzt drei aufeinanderfolgende Punkte durch Auslassungspunkte, auch wenn sie im Text ein Leerzeichen zum Einfügen haben'
    },
    // proper-ellipsis.ts
    'proper-ellipsis': {
    ...
    'quote-style': {
      name: 'Zitatstil',
      description:
        'Aktualisiert die Anführungszeichen im Textkörperinhalt, sodass sie auf die angegebenen einfachen und doppelten Anführungszeichenstile aktualisiert werden.',
    ...
    're-index-footnotes': {
      ...
      description:
        'Indiziert Fußnotenschlüssel und Fußnoten basierend auf der Reihenfolge des Auftretens neu (HINWEIS: Diese Regel funktioniert *nicht*, wenn es mehr als eine Fußnote für einen Schlüssel gibt.)'
    },
    // remove-consecutive-list-markers.ts
    'remove-consecutive-list-markers': {
      name: 'Entfernen Sie aufeinanderfolgende Listenmarkierungen',
      description:
        'Entfernt aufeinanderfolgende Listenmarkierungen. Nützlich beim Kopieren und Einfügen von Listenelementen.'
    },
    ...
    'remove-leading-or-trailing-whitespace-on-paste': {
      ...
      description:
        'Entfernt alle führenden Leerzeichen ohne Tabulatoren und alle nachgestellten Leerzeichen, die der Text einfügen kann'
    },
    ...
    'remove-space-around-characters': {
      ...
      description:
        'Stellt sicher, dass bestimmte Zeichen nicht von Leerzeichen umgeben sind (entweder einzelne Leerzeichen oder ein Tabulator). Beachten Sie, dass dies in einigen Fällen zu Problemen mit dem Markdown-Format führen kann.',
      'include-fullwidth-forms': {
        name: 'Einfügen von Formularen in voller Breite',
        description:
          'Einschließen <a href="https://de.wikipedia.org/wiki/Unicodeblock_Halbbreite_und_vollbreite_Formen">Unicode-Block "Formulare" in voller Breite</a>'
      },
      'include-cjk-symbols-and-punctuation': {
        name: 'CJK-Symbole und Satzzeichen einschließen',
        description:
          'Einschließen <a href="https://de.wikipedia.org/wiki/Unicodeblock_CJK-Symbole_und_-Interpunktion">CJK-Symbole und Satzzeichen Unicode-Block</a>'
      },
      'include-dashes': {
    ...
    'remove-space-before-or-after-characters': {
      ...
      description:
        'Entfernt Leerzeichen vor und nach den angegebenen Zeichen. Beachten Sie, dass dies in einigen Fällen zu Problemen mit dem Markdown-Format führen kann.',
      'characters-to-remove-space-before': {
        name: 'Leerzeichen vor Zeichen entfernen',
        description:
          'Entfernt Leerzeichen vor den angegebenen Zeichen. **Hinweis: Die Verwendung von `{` oder `}` in der Zeichenliste wirkt sich unerwartet auf Dateien aus, da es in der Ignoriersyntax hinter den Kulissen verwendet wird.**'
      },
    ...
    'remove-trailing-punctuation-in-heading': {
      ...
      description:
        'Entfernt die angegebene Interpunktion am Ende von Überschriften, wobei darauf zu achten ist, dass das Semikolon am Ende von [HTML-Entitätsreferenzen](https://de.wikipedia.org/wiki/Typografische_Zeichen_in_XML_und_HTML) ignoriert wird.',
    ...
    'space-between-chinese-japanese-or-korean-and-english-or-numbers': {
      ...
      description:
        'Stellt sicher, dass Chinesisch, Japanisch oder Koreanisch und Englisch oder Zahlen durch ein einziges Leerzeichen getrennt werden. Folgt diesen [Richtlinien](https://github.com/sparanoid/chinese-copywriting-guidelines)'
    },
    // strong-style.ts
    'strong-style': {
      name: 'Starker Stil',
    ...
    'two-spaces-between-lines-with-content': {
      ...
      description:
        'Stellt sicher, dass zwei Leerzeichen an den Zeilenenden hinzugefügt werden, wobei der Inhalt in der nächsten Zeile für Absätze, Blockzitate und Listenelemente fortgesetzt wird'
    },
    ...
    'yaml-key-sort': {
      ...
      description:
        'Sortiert die YAML-Schlüssel basierend auf der angegebenen Reihenfolge und Priorität. Hinweis: Kann auch Leerzeilen entfernen.',
      'yaml-key-priority-sort-order': {
        name: 'Sortierreihenfolge der YAML-Schlüsselpriorität',
        description:
          'Die Reihenfolge, in der Schlüssel sortiert werden sollen, wobei einer in jeder Zeile sortiert wird, in der er in der Reihenfolge sortiert wird, die in der Liste gefunden wird'
      },
      ...
      'yaml-sort-order-for-other-keys': {
        ...
        description:
          'Die Art und Weise, wie die Schlüssel sortiert werden, die nicht im Textbereich Sortierreihenfolge der YAML-Schlüsselpriorität gefunden werden'
      }
    },
    // yaml-timestamp.ts
    'yaml-timestamp': {
      ...
      description:
        'Verfolgen Sie das Datum, an dem die Datei zuletzt bearbeitet wurde, in der YAML-Front. Ruft Datumsangaben aus Dateimetadaten ab.',
      'date-created': {
      ...
      'force-retention-of-create-value': {
        ...
        description:
          'Verwendet den Wert in der YAML-Frontmaterie für das Erstellungsdatum anstelle der Dateimetadaten, was nützlich ist, um zu verhindern, dass Änderungen an Dateimetadaten dazu führen, dass der Wert in einen anderen Wert geändert wird.'
      },
      'date-modified': {
        name: 'Änderungsdatum',
      ...
      format: {
        name: 'Format',
        description:
          'Zu verwendendes Momentdatumsformat (siehe [Momentformatoptionen](https://momentjscom.readthedocs.io/en/latest/moment/04-displaying/01-format/))'
      }
    },
    // yaml-title-alias.ts
    'yaml-title-alias': {
      ...
      description:
        'Fügt den Titel der Datei in den Aliasabschnitt der YAML-Frontmaterie ein. Ruft den Titel aus dem ersten H1- oder Dateinamen ab.',
      'preserve-existing-alias-section-style': {
        name: 'Vorhandenes Alias-Abschnittsformat beibehalten',
        description:
          'Wenn diese Option festgelegt ist, gilt die Einstellung `YAML-Aliase-Abschnittsstil` nur für die neu erstellten Abschnitte'
      },
      ...
      'use-yaml-key-to-keep-track-of-old-filename-or-heading': {
        ...
        description:
          'Wenn sich die erste H1-Überschrift ändert oder der Dateiname geändert wird, wenn der erste H1 nicht vorhanden ist, wird der alte Alias, der in diesem Schlüssel gespeichert ist, durch den neuen Wert ersetzt, anstatt nur einen neuen Eintrag in das Alias-Array einzufügen'
      }
    },
    // yaml-title.ts
    'yaml-title': {
      name: 'YAML-Titel',
      description:
        'Fügt den Titel der Datei in das YAML-Frontmatter ein. Ruft den Titel basierend auf dem ausgewählten Modus ab.',
      'title-key': {
  ...
  enums: {
    ...
    'first-h1-or-filename-if-h1-missing':
      'Erste Überschrift der Ebene 1 oder Dateiname, wenn die Überschrift der Ebene 1 fehlt',
    filename: 'Dateinamen',
    // quote-style.ts
    "''": "''", // leave as is
    '‘’': '‘’', // leave as is
