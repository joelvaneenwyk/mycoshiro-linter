...
export default {
  commands: {
    ...
    'lint-all-files-in-folder': {
      ...
      'start-message':
        'Esto editará todos de sus archivos en {FOLDER_NAME} incluyendo los archivos que existen en las subcarpetas y es possible que introduzca errores.',
  ...
  logs: {
    ...
    'paste-link-warning':
      'abortó lint de pagar porque el contento del portapapeles es un enlace y no lo hizo para evitar conflictos con otros programas adicionales que modifican lo que hace el pegar.',
    ...
    'invalid-date-format-error':
      'No se pudo analizar ni identificar el formato de la fech de creación `{DATE}` entonces la fecha de creación se dejó sola en `{FILE_NAME}`',
    'invalid-delimiter-error-message': 'El delimitador solo puede ser de un solo carácter',
    'missing-footnote-error-message':
      'La nota al pie `{FOOTNOTE}` no tiene ninguna referencia de nota al pie correspondiente antes del contenido de la nota al pie y no se puede procesar. Asegúrese de que todas las notas a pie de página tengan una referencia correspondiente antes del contenido de la nota al pie de página.',
    'too-many-footnotes-error-message':
      "La clave de nota al pie '{FOOTNOTE_KEY}' tiene más de 1 nota al pie que hace referencia a ella. Actualice las notas al pie para que solo haya una nota al pie por clave de nota al pie.",
    ...
    'uneven-amount-of-quotes':
      'Las instancias de la cita `{QUOTE}` en el archivo no son pares, por lo que no podemos convertir las comillas rectas en comillas tipográficas.'
  },
  'notice-text': {
  ...
  tabs: {
    ...
    general: {
      ...
      'folders-to-ignore': {
        ...
        description:
          'Carpetas que se deben omitir al analizar todos los archivos o al guardar en línea. Introducir rutas de carpeta separadas por nuevas líneas'
      },
      'lint-on-file-change': {
      ...
      'override-locale': {
        ...
        description:
          'Establezca esta opción si desea utilizar una configuración regional diferente de la predeterminada'
      },
      ...
      'default-escape-character': {
        ...
        description:
          'El carácter predeterminado que se va a usar para escapar de los valores YAML cuando no hay comillas simples y comillas dobles.'
      },
      'remove-unnecessary-escape-chars-in-multi-line-arrays': {
        ...
        description:
          'Los caracteres de escape para matrices de YAML multilínea no necesitan el mismo escape que las matrices de una sola línea, por lo que cuando están en formato multilínea, elimine los escapes adicionales que no son necesarios'
      },
      'number-of-dollar-signs-to-indicate-math-block': {
        name: 'Número de signos de dólar para indicar el bloque matemático',
        description:
          'La cantidad de signos de dólar para considerar el contenido matemático como un bloque matemático en lugar de matemáticas en línea'
      }
    },
    debug: {
      'log-level': {
      ...
      'log-collection': {
        ...
        description:
          'Continúa y recopila registros cuando `Analizar en guardar` y analizar el archivo actual. Estos registros pueden ser útiles para depurar y crear informes de errores.'
      },
      'linter-logs': {
        name: 'Registros de Linter',
        description:
          'Los registros del último `Analizar en guardar` o del último archivo actual de analizar se ejecutan si están habilitados.'
      }
    }
  },
  options: {
    'custom-command': {
      ...
      description:
        'Los comandos personalizados son comandos de Obsidian que se ejecutan después de que Linter termina de ejecutar sus reglas regulares. Esto significa que no se ejecutan antes de que se ejecute la lógica de marca de tiempo YAML, por lo que pueden hacer que la marca de tiempo de YAML se active en la siguiente ejecución del Linter. Solo puede seleccionar un comando de Obsidian una vez. **_Note que esto actualmente solo funciona para analizar el archivo actual._**',
      warning:
        'Al seleccionar una opción, asegúrese de seleccionar la opción usando el ratón o presionando la clave Intro. Es posible que otros métodos de selección no funcionen y solo se guardarán las selecciones de un comando de Obsidian real o una cadena vacía.',
    ...
    'custom-replace': {
      ...
      description:
        'El reemplazo de regex personalizado se puede usar para reemplazar cualquier cosa que coincida con el valor de búsqueda de regex con el valor de reemplazo. Los valores de reemplazo y búsqueda deberán ser valores regex válidos.',
      warning:
        'Use esto con precaución si no conoce regex. Además, asegúrese de no usar lookbehinds en su regex en dispositivos móviles iOS, ya que eso hará que falle analizar ya que no es compatible con esa plataforma.',
  ...
  rules: {
    ...
    'add-blockquote-indentation-on-paste': {
      ...
      description:
        'Agrega blockquotes a todas menos a la primera línea, cuando el cursor está en una línea blockquote/callout durante el pegado'
    },
    'blockquote-style': {
    ...
    'empty-line-around-blockquotes': {
      ...
      description:
        'Asegura que haya una línea vacía alrededor de blockquotes a menos que inicien o finalicen un documento. **Tenga en cuenta que una línea vacía es un nivel menos de anidamiento para blockquotes o un carácter de nueva línea.**'
    },
    'empty-line-around-code-fences': {
      name: 'Línea vacía alrededor de las vallas de código',
      description:
        'Garantiza que haya una línea vacía alrededor de las vallas de código a menos que inicien o finalicen un documento.'
    },
    'empty-line-around-math-blocks': {
      name: 'Línea vacía alrededor de los bloques matemáticos',
      description:
        'Asegura que haya una línea vacía alrededor de los bloques matemáticos usando `Número de signos de dólar para indicar un bloque matemático` para determinar cuántos signos de dólar indica un bloque matemático para matemáticas de una sola línea.'
    },
    'empty-line-around-tables': {
      name: 'Línea vacía alrededor de las tablas',
      description:
        'Asegura que haya una línea vacía alrededor de las tablas con sabor a github a menos que inicien o finalicen un documento.'
    },
    'escape-yaml-special-characters': {
      name: 'Evitar los caracteres especiales de YAML',
      description:
        'Escapa dos puntos con un espacio después de ellos (:), comillas simples (\') y comillas dobles (") en YAML.',
    ...
    'force-yaml-escape': {
      ...
      'force-yaml-escape-keys': {
        ...
        description:
          'Utiliza el carácter de escape de YAML en las claves de YAML especificadas separadas por un nuevo carácter de línea si aún no está escapado. No lo use en matrices de YAML.'
      }
    },
    'format-tags-in-yaml': {
      name: 'Dar formato a las etiquetas de formato en YAML',
      description:
        'Elimine los hashtags de las etiquetas en el frontmatter del YAML, ya que hacen que las etiquetas no sean válidas.'
    },
    'format-yaml-array': {
      ...
      'alias-key': {
        ...
        description:
          'Activa el formato para la sección de alias YAML. No debe habilitar esta opción junto con la regla `Alias de título YAML`, ya que es posible que no funcionen bien juntos o que tengan diferentes estilos de formato seleccionados que causen resultados inesperados.'
      },
      'tag-key': {
      ...
      'default-array-style': {
        ...
        description:
          'El estilo de otras matrices de YAML que no son `etiquetas`, `alias` o en `Forzar valores de clave para que sean matrices de una sola línea` y `Forzar valores de clave para que sean matrices multilínea`'
      },
      'default-array-keys': {
      ...
      'force-single-line-array-style': {
        ...
        description:
          'Fuerza la matriz de YAML para que las nuevas claves separadas por línea estén en formato de una sola línea (deje vacío para deshabilitar esta opción)'
      },
      'force-multi-line-array-style': {
        name: 'Forzar que los valores de las claves sean matrices multilíneas',
        description:
          'Fuerza la matriz de YAML para que las nuevas claves separadas por línea estén en formato multilínea (deje vacía para deshabilitar esta opción)'
      }
    },
    'header-increment': {
      ...
      'start-at-h2': {
        ...
        description:
          'Hace que el nivel de encabezado 2 sea el nivel de título mínimo en un archivo para el incremento de encabezado y desplaza todos los encabezados en consecuencia para que se incrementen a partir de un encabezado de nivel 2.'
      }
    },
    'heading-blank-lines': {
      name: 'Líneas en blanco de encabezado',
      description:
        'Todos los encabezados tienen una línea en blanco antes y después (excepto cuando el encabezado está al principio o al final del documento).',
      bottom: {
        name: 'Abajo',
    ...
    'headings-start-line': {
      ...
      description:
        'Los encabezados que no inician una línea tendrán su espacio en blanco anterior eliminado para asegurarse de que se reconozcan como encabezados.'
    },
    'insert-yaml-attributes': {
      name: 'Insertar atributos de YAML',
      description:
        'Inserta los atributos especificados de YAML en el frontmatter del YAML. Coloque cada atributo en una sola línea.',
      'text-to-insert': {
    ...
    'move-math-block-indicators-to-their-own-line': {
      ...
      description:
        'Mueva todos los indicadores de bloques matemáticos iniciales y finales a sus propias líneas usando `Número de signos de dólar para indicar un bloque matemático` para determinar cuántos signos de dólar indica un bloque matemático para matemáticas de una sola línea.'
    },
    'move-tags-to-yaml': {
      ...
      'tags-to-ignore': {
        ...
        description:
          'Las etiquetas que no se moverán a la matriz de etiquetas ni se eliminarán del contenido del cuerpo si está habilitado `Eliminar el hashtag de las etiquetas en el cuerpo del contenido`. Cada etiqueta debe estar en una nueva línea y sin el `#`. **Asegúrese de no incluir el hashtag en el nombre de la etiqueta.**'
      }
    },
    'no-bare-urls': {
      name: 'Sin URL desnuda',
      description:
        'Encierra las direcciones URL desnudas con corchetes angulares, excepto cuando están encerradas en marcas traseras, llaves cuadradas o comillas simples o dobles.'
    },
    'ordered-list-style': {
      name: 'Estilo de lista ordenada',
      description:
        'Se asegura de que las listas ordenadas siguen el estilo especificado. Tenga en cuenta que 2 espacios o 1 tabulación se considera un nivel de sangría.',
      'number-style': {
    ...
    'prevent-double-checklist-indicator-on-paste': {
      ...
      description:
        'Elimina el indicador de lista de verificación inicial del texto para pegar si la línea en la que se encuentra el cursor en el archivo tiene un indicador de lista de verificación'
    },
    'prevent-double-list-item-indicator-on-paste': {
      name: 'Prevenir el indicador de elemento de lista doble al pegar',
      description:
        'Elimina el indicador de lista inicial del texto para pegar si la línea en la que se encuentra el cursor en el archivo tiene un indicador de lista'
    },
    ...
    're-index-footnotes': {
      ...
      description:
        'Vuelve a indexar las notas al pie de página y las notas al pie, según el orden de aparición (NOTA: esta regla *no* funciona si hay más de una nota al pie para una clave).'
    },
    ...
    'remove-leading-or-trailing-whitespace-on-paste': {
      ...
      description:
        'Elimina cualquier espacio en blanco inicial que no sea una pestaña y todos los espacios en blanco finales para que el texto se pegue'
    },
    ...
    'remove-space-around-characters': {
      ...
      description:
        'Garantiza que determinados caracteres no estén rodeados de espacios en blanco (ya sean espacios individuales o tabulaciones). Tenga en cuenta que esto puede causar problemas con el formato de descuento en algunos casos.',
      ...
      'include-cjk-symbols-and-punctuation': {
        ...
        description:
          'Incluir <a href="https://en.wikipedia.org/wiki/CJK_Symbols_and_Punctuation">Bloque Unicode de símbolos y puntuación de CJK</a>'
      },
      'include-dashes': {
    ...
    'remove-space-before-or-after-characters': {
      ...
      description:
        'Elimina el espacio antes de los caracteres especificados y después de los caracteres especificados. Tenga en cuenta que esto puede causar problemas con el formato de descuento en algunos casos.',
      'characters-to-remove-space-before': {
        name: 'Eliminar espacio antes de los caracteres',
        description:
          'Elimina el espacio antes de los caracteres especificados. **Nota: el uso de `{` o `}` en la lista de caracteres afectará inesperadamente a los archivos, ya que se usa en la sintaxis de ignorar en segundo plano.**'
      },
      'characters-to-remove-space-after': {
        name: 'Eliminar espacio después de los caracteres',
        description:
          'Elimina el espacio después de los caracteres especificados. **Nota: el uso de `{` o `}` en la lista de caracteres afectará inesperadamente a los archivos, ya que se usa en la sintaxis de ignorar en segundo plano.**'
      }
    },
    'remove-trailing-punctuation-in-heading': {
      name: 'Eliminar la puntuación final en el encabezado',
      description:
        'Elimina la puntuación especificada al final de los encabezados, asegurándose de ignorar el punto y coma al final de [referencias de entidades de HTML](https://es.wikipedia.org/wiki/Anexo:Referencias_a_entidades_de_caracteres_XML_y_HTML).',
    ...
    'space-between-chinese-japanese-or-korean-and-english-or-numbers': {
      ...
      description:
        'Garantiza que el chino, el japonés o el coreano y el inglés o los números estén separados por un solo espacio. Sigue estas [directrices](https://github.com/sparanoid/chinese-copywriting-guidelines)'
    },
    'strong-style': {
      name: 'Estilo fuerte',
    ...
    'two-spaces-between-lines-with-content': {
      ...
      description:
        'Se asegura de que se agreguen dos espacios al final de las líneas con contenido que continúa en la siguiente línea para párrafos, comillas y elementos de lista'
    },
    ...
    'yaml-key-sort': {
      ...
      description:
        'Ordena las claves de YAML según el orden y la prioridad especificados. Nota: también puede eliminar las líneas en blanco.',
      'yaml-key-priority-sort-order': {
        name: 'Orden de clasificación de prioridad de clave de YAML',
        description:
          'El orden en el que se ordenan las claves con una en cada línea donde se ordena en el orden que se encuentra en la lista'
      },
      'priority-keys-at-start-of-yaml': {
        name: 'Claves de prioridad al inicio del YAML',
        description:
          'El orden de clasificación de prioridad clave de YAML se coloca al comienzo del frontmatter del YAML'
      },
      'yaml-sort-order-for-other-keys': {
        name: 'Orden de clasificación de YAML para otras claves',
        description:
          'La forma en que ordenar las claves que no se encuentran en el área de texto `Orden de clasificación de prioridad de clave de YAML`'
      }
    },
    'yaml-timestamp': {
      name: 'Marca de tiempo de YAML',
      description:
        'Lleve un registro de la fecha en que se editó el archivo por última vez en el frente del YAML. Obtiene las fechas de los metadatos del archivo.',
      'date-created': {
      ...
      'force-retention-of-create-value': {
        ...
        description:
          'Reutiliza el valor en el frontmatter del YAML para la fecha de creación en lugar de los metadatos del archivo, lo que es útil para evitar que los cambios en los metadatos del archivo provoquen que el valor cambie a un valor diferente.'
      },
      'date-modified': {
    ...
    'yaml-title-alias': {
      ...
      description:
        'Inserta el título del archivo en la sección de alias de YAML frontmatter. Obtiene el título del primer H1 o nombre de archivo.',
      'preserve-existing-alias-section-style': {
        name: 'Conservar el estilo de sección de alias existente',
        description:
          'Si se establece, la configuración `Estilo de sección de alias de YAML` se aplica solo a las secciones recién creadas'
      },
      ...
      'use-yaml-key-to-keep-track-of-old-filename-or-heading': {
        ...
        description:
          'Si se establece, cuando cambia el primer encabezado H1 o cambia el nombre de archivo si el primer H1 no está presente, el alias anterior almacenado en esta clave se reemplazará con el nuevo valor en lugar de simplemente insertar una nueva entrada en la matriz de alias.'
      }
    },
    'yaml-title': {
      name: 'Título de YAML',
      description:
        'Inserta el título del archivo en el frontmatter de YAML. Obtiene el título según el modo seleccionado.',
      'title-key': {
