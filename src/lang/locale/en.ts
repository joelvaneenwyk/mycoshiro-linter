...
export default {
  ...
  logs: {
    ...
    'uneven-amount-of-quotes':
      'The instances of the `{QUOTE}` quote in the file is not even, so we cannot convert straight quotes to smart quotes'
  },
  ...
  tabs: {
    ...
    general: {
      ...
      'folders-to-ignore': {
        ...
        description:
          'Folders to ignore when linting all files or linting on save. Enter folder paths separated by newlines'
      },
      'override-locale': {
