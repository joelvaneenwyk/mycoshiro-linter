...
const testCases: YAMLStringTestCase[] = [
  ...
  {
    testName:
      'A single single quote in the string should not result in an escaped value and it should parse it as normal',
    delimiter: ',',
  ...
  {
    testName:
      'A single double quote in the string should not result in an escaped value and it should parse it as normal',
    delimiter: ',',
