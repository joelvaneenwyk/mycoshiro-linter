...
ruleTest({
  ...
  testCases: [
    ...
    },
    {
      // accounts for https://github.com/platers/obsidian-linter/issues/412
      testName:
        'When H1 does not exist in the file, the minimum header is an H2 and incrementing starts from that level',
      before: dedent`
        ### H3
        #### H4
        ## H2
    ...
    },
    {
      ...
      testName:
        'When decreasing the heading level, when the previous value was decreased and the next value is 1 more than the decreased value, but the same as the value just decremented, make sure the header is decremented with `startAtH2 = true`',
      before: dedent`
        ## HHELLO
        #### HHELLO
        ## HHELLO
    ...
    },
    {
      ...
      testName:
        'When decreasing the heading level, when the previous value was decreased and the next value is 1 more than the decreased value, but the same as the value just decremented, make sure the header is decremented',
      before: dedent`
        ## Second
        ### Third
        ## Second again
    ...
    },
    {
      // accounts for https://github.com/platers/obsidian-linter/issues/589
      testName:
        'Make sure that when all header levels are present and we need to start at H2, that the H6 is left as an H6 since H7 is not valid',
      before: dedent`
        # H1
        ## H2
        ### H3
